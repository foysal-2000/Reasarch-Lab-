...
<div class="container mt-5">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <div>Almuni Student Informaion</div>
            <a href="{{route('backend.almuni.index')}}" class="btn btn-primary">Student List</a>
        </div>
        <div class="card-body">
    <form action="{{route('backend.almuni.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="row">
                <div class="col-md-4">
