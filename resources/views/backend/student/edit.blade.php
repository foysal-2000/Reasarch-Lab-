...
<div class="container mt-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
    <form action="{{route('backend.student.update',$student->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div>
                        ...
                        <img src="Student/{{$student->photo}}" alt="Previous Photo" style="max-width: 50px;">
                    </div>
                @endif
                </div>
                <div class="col-md-4">
                    <label class="student_name">Linkdin ID</label>
                    <input type="text" name="linkdin" class="form-control"  value="{{ $student->linkdin}}">
                </div>
            </div><br>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="link" name="schoolr_link" class="form-control"  value="{{$student->schoolr_link}}">
                </div>
            </div><br>
        </div>
